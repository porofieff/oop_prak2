...
# Project:  Prak1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Prak1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Prak11.0.0
DISTDIR = /home/porofieff/Documents/Leti/OOP/Practise/oop_prak1/.tmp/Prak11.0.0
LINK          = g++
LFLAGS        = -fPIC
...
Makefile: Prak1.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Prak1.pro
	$(QMAKE) -o Makefile Prak1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Prak1/bin || mkdir -p $(INSTALL_ROOT)/opt/Prak1/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Prak1/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Prak1/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Prak1/bin/ 
